...
<head>
    ...
    <style>
        * { margin:0;padding:0;box-sizing:border-box }
        ...
        .erro-icone { font-size:5rem;color:#dc3545;margin-bottom:16px }
...
<body>
    <div class="erro-container">
        <div class="erro-icone"><i class="bi bi-exclamation-triangle-fill"></i></div>
        <div class="erro-codigo">500</div>
        <h1 class="erro-titulo">Erro interno do servidor</h1>
        <p class="erro-desc">Algo inesperado aconteceu. Nossa equipe já foi notificada e estamos trabalhando para resolver o problema.</p>
